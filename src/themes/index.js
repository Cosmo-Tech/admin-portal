  ...
  return {
    palette: {
      ...
      accessManagement: {
        ...
        scopeButtonBg: isLight ? '#F5F6F8' : '#1A1D23',
        scopeButtonBorder: isLight ? '#D0D5DD' : '#323A45',
        scopeButtonHoverBg: isLight ? '#ECEFF3' : '#232A33',
        scopeButtonHoverBorder: isLight ? '#BCC4CF' : '#535D6B',
        scopeButtonText: isLight ? '#4C5663' : '#A8B2BF',
        scopeButtonSelectedBg: isLight ? '#FFF2E0' : '#3A2F21',
        scopeButtonSelectedText: isLight ? '#9A5A10' : '#FFB752',
        scopeButtonSelectedBorder: isLight ? '#E9AE67' : '#CB8731',
        scopeButtonSelectedHoverBg: isLight ? '#FFE9CC' : '#463828',
        ...
        platformRoleChipBg: isLight ? '#FF9F1C' : '#D8861A',
        platformRoleChipText: isLight ? '#FFFFFF' : '#231400',
        platformRoleChipBorder: isLight ? '#E38B14' : '#F2A536',
        countChipBg: isLight ? '#F8EBD7' : '#3A2A14',
        countChipText: '#FFB752',
        avatarText: '#FFC56F',
        avatarFallbackBg: isLight ? '#6B4A1E' : '#81602D',
        ...
        assignButtonHoverText: '#FFB752',
        assignButtonDisabledBg: isLight ? '#F3F5F8' : '#242A32',
        assignButtonDisabledBorder: isLight ? '#D6DCE5' : '#3A424C',
        assignButtonDisabledText: isLight ? '#9AA4B0' : '#778290',
        roleButtonBg: isLight ? '#EAF2FF' : '#1C2A3D',
        roleButtonBorder: isLight ? '#9FBBEA' : '#335A89',
        roleButtonText: isLight ? '#2453A5' : '#8FB7F3',
        roleButtonHoverBg: isLight ? '#DFEBFF' : '#223650',
        roleButtonHoverBorder: isLight ? '#7CA5E2' : '#4A78AF',
        roleButtonDraftText: isLight ? '#6A7480' : '#9AA4B0',
        draftAutoBg: isLight ? 'rgba(255, 159, 28, 0.08)' : 'rgba(255, 159, 28, 0.14)',
        draftAutoBorder: isLight ? '#FF9F1C' : '#FFB752',
        autoDraftCheck: isLight ? '#159947' : '#35D07B',
        draftDirectBg: isLight ? 'rgba(20, 201, 122, 0.10)' : 'rgba(20, 201, 122, 0.16)',
        draftDirectBorder: isLight ? '#0FA15F' : '#22C975',
        footerBg: isLight ? '#FFF4E8' : '#2A2218',
        footerBorder: isLight ? '#F3C48D' : '#5A4428',
        footerText: isLight ? '#8F632B' : '#D1A267',
        footerPrimaryBg: '#FF9F1C',
        footerPrimaryHoverBg: isLight ? '#E68E14' : '#F2A536',
        footerPrimaryText: isLight ? '#FFFFFF' : '#1F1305',
        footerSecondaryBg: isLight ? '#F3F5F8' : '#252C34',
        footerSecondaryHoverBg: isLight ? '#E7ECF2' : '#2D3640',
        footerSecondaryText: isLight ? '#5D6774' : '#A1AAB6',
        inlineErrorBg: isLight ? '#FFEDEF' : '#341A1E',
        inlineErrorBorder: isLight ? '#F7B8BF' : '#7F3340',
        inlineErrorText: isLight ? '#8F1F30' : '#F2A7B2',
        inlineSuccessBg: isLight ? '#EAFBF0' : '#152C20',
        inlineSuccessBorder: isLight ? '#97D7AF' : '#2F7A4F',
        inlineSuccessText: isLight ? '#1D6A3D' : '#8BE3B0',
        menuBg: isLight ? '#FFFFFF' : '#1B1F26',
        menuBorder: isLight ? '#DEE4EC' : '#2F3845',
        treeIconColors: {
          ORGANIZATION: '#FF9F1C',
          SOLUTION: '#3FA4FF',
          WORKSPACE: '#14C97A',
